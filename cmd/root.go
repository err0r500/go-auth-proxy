...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-auth-proxy.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".go-auth-proxy" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".go-auth-proxy")
	}
